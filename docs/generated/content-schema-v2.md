...
| `fixed_page.g.global.schedule.overrides.item.date` | G | `global.schedule.overrides[].date` | string | no | yes |
| `fixed_page.g.global.schedule.overrides.item.note_de` | G | `global.schedule.overrides[].note_de` | string | no | yes |
| `fixed_page.g.global.schedule.overrides.item.note_en` | G | `global.schedule.overrides[].note_en` | string | no | yes |
...
| `fixed_page.l.hero.show_cta_ghost` | L | `locales.{locale}.hero.show_cta_ghost` | boolean | no | yes |
| `fixed_page.l.hero.show_cta_primary` | L | `locales.{locale}.hero.show_cta_primary` | boolean | no | yes |
| `fixed_page.l.hero.show_cta_secondary` | L | `locales.{locale}.hero.show_cta_secondary` | boolean | no | yes |
...
| `fixed_page.l.invitation.p3` | L | `locales.{locale}.invitation.p3` | string | no | yes |
...
| `fixed_page.l.labs.cta_button` | L | `locales.{locale}.labs.cta_button` | string | no | yes |
| `fixed_page.l.labs.cta_text` | L | `locales.{locale}.labs.cta_text` | string | no | yes |
| `fixed_page.l.labs.cta_url` | L | `locales.{locale}.labs.cta_url` | string | no | yes |
| `fixed_page.l.labs.heading` | L | `locales.{locale}.labs.heading` | string | no | yes |
| `fixed_page.l.labs.intro` | L | `locales.{locale}.labs.intro` | string | no | yes |
| `fixed_page.l.labs.items.item.link` | L | `locales.{locale}.labs.items[].link` | string | no | yes |
| `fixed_page.l.labs.items.item.name` | L | `locales.{locale}.labs.items[].name` | string | no | yes |
| `fixed_page.l.labs.items.item.status_label` | L | `locales.{locale}.labs.items[].status_label` | string | no | yes |
| `fixed_page.l.labs.items.item.text` | L | `locales.{locale}.labs.items[].text` | string | no | yes |
| `fixed_page.l.labs.label` | L | `locales.{locale}.labs.label` | string | no | yes |
...
| `fixed_page.l.propose.button` | L | `locales.{locale}.propose.button` | string | no | yes |
| `fixed_page.l.propose.heading` | L | `locales.{locale}.propose.heading` | string | no | yes |
| `fixed_page.l.propose.label` | L | `locales.{locale}.propose.label` | string | no | yes |
| `fixed_page.l.propose.p1` | L | `locales.{locale}.propose.p1` | string | no | yes |
| `fixed_page.l.propose.p2` | L | `locales.{locale}.propose.p2` | string | no | yes |
...
| `workshop.g.global.id` | G | `global.id` | string | yes | no |
