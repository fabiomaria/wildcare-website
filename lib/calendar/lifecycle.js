...
function deriveWorkshopStatus(configuredStatus, schedule, nowLocal = localMinute()) {
...
module.exports = { DEFAULT_TIME_ZONE, localMinute, finalSessionEnd, deriveWorkshopStatus };
