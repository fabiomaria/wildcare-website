...
const { deriveDatedStatus, deriveWorkshopStatus, finalSessionEnd, localMinute } = require("./lifecycle");
...
test("uses the same date lifecycle for a one-off event", () => {
  assert.equal(deriveDatedStatus("current", {
    mode: "dates",
    sessions: [{ start_local: "2026-08-10T17:30", end_local: "2026-08-10T21:00" }],
  }, "2026-08-11T00:00"), "past");
});
